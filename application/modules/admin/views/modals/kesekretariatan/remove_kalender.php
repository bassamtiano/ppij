<div class="modal fade " id="modal_remove" tabindex="-1" role="dialog" aria-labelledby="add_gambar">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url('index.php/admin//kalender_remove') ?>">
                <div class="modal-body">
                    Do you want to remove <span id="modal-delete-name"></span>
                    <input id="modal-delete-id" type="hidden" name="id">
                    <input id="modal-delete-thumbnail" type="hidden" name="thumbnail">
                    <input id="modal-delete-poster" type="hidden" name="poster">
                </div>
