                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <a href=" <?php echo $admin_url . '/panduanstudi/beasiswa/add' ?> " class="btn btn-primary">Add Jurnal</a> 
                                        ...
                                        <?php
                                            ...
                                            foreach ($data as $dkey => $dval) {
                                                echo '<tr>';
                                                    ...
                                                    echo '<td>' . $dval->deadline . '</td>';
                                                    echo '<td>' . $dval->thumbnail . '</td>';
                                                    echo '<td>' . $dval->created_at . '</td>';
                                                    echo '<td>';
                                                        echo '<a href="' . $admin_url . '/panduanstudi/beasiswa/' . $dval->id . '" class="btn btn-warning">Edit</a>';
                                                        ?>
                                                            <a href="" data-toggle="modal" data-target="#modal_remove" class="btn btn-danger" onclick="modal_delete('<?php echo $dval->title ?>',' <?php echo $dval->id ?>', '<?php echo $dval->thumbnail ?>')">Delete</a>
                                                        <?php
